...
Tcheran - https://github.com/tcheran-chess/tcheran

#### Who is the main author of your engine’s code?

jgilchrist (Jonathan Gilchrist)

#### Which are your usernames (handles) in TCEC Discord and Twitch chat?

@jgilchrist or @Jonathan in Discord.
...
The engine is licensed under the GNU AGPL v3.0. It also uses fathom for tablebase probing which is MIT licensed.

#### Please name the parts and the authors of the code you use for training in case you use a neural network?

Tcheran uses the bullet trainer by jw1912 (Jamie Whiting) for training its networks
...
All data is generated exclusively from self-play games and is published online at https://huggingface.co/datasets/jgilchrist/tcheran/tree/main.
...
Tcheran uses fathom (https://github.com/jdart1/Fathom) for tablebase probing.
...
Yes - the NNUE code was written from scratch for Tcheran, and networks are trained exclusively on self-play data.
...
Tcheran has always had legal move generation which, while not unique, was unusual until recently.
I don't believe there are any particularly unique features, it is otherwise a fairly typical alpha-beta engine.

#### What is your engine's approximate elo?

v12.0 is 3655 CCRL Blitz.
